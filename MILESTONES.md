# Milestones: Pocket Monsters Ultra Sun

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-UltraSun-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Ultra Sun |
...
Coordinate with Ultra Moon and compare against Sun/Moon using explicit versioned manifests.
